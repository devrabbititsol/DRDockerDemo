...
public class TC_Test2 extends BaseClass {
	...
	public TC_Test2() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_Test2.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("tc_test2.properties");
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, Screen2.projectName);
		test = reports.startTest("TC_Test2");
	}
	
	public void setUP() throws Exception {
		String primaryInfo = Screen2.primaryInfo;
